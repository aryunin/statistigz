INSERT INTO survey(name) VALUES ('Индивидуальный подбор регионов');

-----------------------------------------------------------------------------------------------------------
INSERT INTO question(survey_id, text, order_idx) VALUES (1, 'Ваш возраст', 1);
INSERT INTO "option"(question_id, text, order_idx) VALUES
    (1, '12-16', 1),
    (1, '17-22', 2),
    (1, '23-27', 3),
    (1, '28-45', 4),
...
-----------------------------------------------------------------------------------------------------------
INSERT INTO question(survey_id, text, order_idx) VALUES (1, 'Ваш пол', 2);
INSERT INTO "option"(question_id, text, order_idx) VALUES
    (2, 'М', 1),
    (2, 'Ж', 2);

-----------------------------------------------------------------------------------------------------------
INSERT INTO question(survey_id, text, order_idx) VALUES (1, 'Представьте, что есть система персональной подборки лучших регионов, которые вам наиболее всего подходят, для чего вы бы рассматривали этот список?', 3);
INSERT INTO "option"(question_id, text, order_idx) VALUES
